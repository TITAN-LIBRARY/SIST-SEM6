...
static yyconst short int yy_base[16] =
    {   0,
        0,    0,   13,   14,    0,   10,    9,   14,    0,    0,
        0,   14,    8,    4,    6
    } ;

static yyconst short int yy_def[16] =
    {   0,
       12,    1,   12,   12,   13,   14,   14,   12,   13,   15,
        7,    0,   12,   12,   12
    } ;

static yyconst short int yy_nxt[20] =
    {   0,
        4,    5,    6,    7,    8,   11,   11,   10,   10,    9,
       10,   10,   12,    3,   12,   12,   12,   12,   12
    } ;

static yyconst short int yy_chk[20] =
    {   0,
        1,    1,    1,    1,    1,   14,   14,   15,   15,   13,
        7,    6,    3,   12,   12,   12,   12,   12,   12
    } ;
