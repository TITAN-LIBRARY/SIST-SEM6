...
DBpath=r'DBQ=D:\AAdityAA\SIST\Sem 6\ML and DA Lab\Database1.accdb;'
def insert():
    ins = Toplevel()
    name=StringVar()
    regno=IntVar()
    ...
    def run():
        ...
        conn_str = (
            ...
            r'DBQ=D:\AAdityAA\SIST\Sem 6\ML and DA Lab\Database1.accdb;' #path of Database of accdb after creation
        )
